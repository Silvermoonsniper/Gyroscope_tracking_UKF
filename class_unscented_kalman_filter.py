...
class UKF:
    ...
    def resetUKF(self, _Q, _R, x_0,rawmeasurement):
        # Q - filter process noise covraiance
        # R - measurement noise covariance,
        # P - init covariance noise

        self.mngm = obseervation_data_state_model_generation.MNGM2(self.n, x_0,rawmeasurement)
